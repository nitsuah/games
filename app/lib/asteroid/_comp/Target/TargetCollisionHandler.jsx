  ...
  useFrame(() => {
    ...
    const activeTargets = targets
      ...
      .map(t => ({
        ...
        radius: t.size || 10,
        // Mass proportional to volume: assuming t.size is radius, volume = (4/3)πr³
        // Simplified to r³ for gameplay purposes (π and 4/3 constants don't affect collision ratios)
        mass: (t.size || 10) ** 3,
      }));
