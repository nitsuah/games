import { generateInitialTargets, TARGET_CONFIG } from './generateTargets';

// Prevent Next.js from executing test suites during build by guarding
// the top-level test runner calls. Tests remain runnable by Jest.
