...
- [ ] Restore `npm run test:coverage` to passing. Tank Battle (`lib/tank/TankGame.jsx`, added 2026-08-07) is untested, which pulls global coverage to 61% against the 75% threshold (2026-09-24 PMO audit; see TASKS.md P1).
